...
public class SwipeToDismissListViewAdaper extends ArrayAdapter<String> {

	private LayoutInflater inflater;
	private ArrayList<String> items;
	private ListView listView;

	public SwipeToDismissListViewAdaper(Context context, int resource,ArrayList<String> items) {
		...
		private void swipeRemoveWithSlideOutAnims(final View view, float deltaX) {			
			...
			animation.setAnimationListener(new AnimationListener() {
				...
				public void onAnimationEnd(Animation animation) {
					...
					view.setVisibility(View.GONE);	//	at last this saved me the day
